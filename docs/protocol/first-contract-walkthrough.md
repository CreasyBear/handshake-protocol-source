...
This remains a reference kernel walkthrough. Active shipment scope is owned by
[`docs/business/canonical-product.md`](../business/canonical-product.md), and any
product walkthrough should link there instead of copying shipment claims here.
