...
import { DigestSchema, PROTOCOL_VERSION, type JsonValue } from "../protocol/schemas";
import { acceptedAtNow, type TransitionRequestContextDraft } from "../protocol/transition-request-contexts";
...
export async function transitionRequestHeaderContextFor(
  ...
  if (requestIdentity.length > MAX_REQUEST_IDENTITY_LENGTH) {
    throw new HandshakeProtocolError(
      ...
      "X-Handshake-Request-Identity is too long.",
      400,
    );
  }
