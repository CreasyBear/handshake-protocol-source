...
export const transitionRouteDefinitions = [
  ...
  route(
    ...
    "gateway_custody",
    directBodyScope,
    "Register an opaque gateway-owned credential reference without exposing secret material",
    RegisterGatewayCredentialRefInputSchema,
  ...
  route(
    ...
    "gateway_custody",
    recordScope("gateway_credential_ref", "gatewayCredentialRefId", "gateway_credential_ref_missing"),
    "Record a redacted gateway custody proof packet without minting authority",
    RecordGatewayCustodyProofPacketInputSchema,
    "Gateway custody proof packet",
    GatewayCustodyProofPacketSchema,
  ),
  route(
    ...
    "Record gateway-side credential resolution evidence after a passed gateway check",
    RecordCredentialResolutionEvidenceInputSchema,
