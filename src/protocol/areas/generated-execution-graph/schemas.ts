...
export const GraphIssuerAuthoritySchema = z.enum(["host_runtime_adapter", "kernel_fixture", "conformance_fixture"]);
...
export const GeneratedGraphNodeProjectionRefSchema = z.strictObject({
  nodeId: IdSchema,
  nodeDigest: DigestSchema,
  classification: GeneratedExecutionNodeClassificationSchema,
  actionTypeId: IdSchema.nullable().default(null),
...
export const GeneratedGraphEvidenceProjectionSchema = z.strictObject({
  graphRef: IdSchema,
  runtimeExecutionRef: IdSchema,
  executionBlockDigest: DigestSchema,
  coverageStatus: GeneratedExecutionCoverageStatusSchema,
  terminalReasonCodes: z.array(ReasonCodeSchema).default([]),
  contractableNodeRefs: z.array(GeneratedGraphNodeProjectionRefSchema).default([]),
  refusedNodeRefs: z.array(GeneratedGraphNodeProjectionRefSchema).default([]),
