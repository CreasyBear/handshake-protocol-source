...
const idFields = {
  ...
  delegated_authority_ref: "delegatedAuthorityRefId",
  delegated_authority_status_transition: "delegatedAuthorityStatusTransitionId",
  ...
  idempotency_ledger_entry: "idempotencyLedgerEntryId",
  ...
  linked_agreement: "linkedAgreementId",
  agreement_obligation_binding: "agreementObligationBindingId",
  agreement_status_transition: "agreementStatusTransitionId",
  action_contract: "actionContractId",
  authority_certificate: "authorityCertificateId",
