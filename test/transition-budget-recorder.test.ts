...
const policyBudget = budget({ maxReads: 8, maxWrites: 1, maxCommittedRecords: 2, maxEmittedEvents: 6, maxStreamPartitionsTouched: 3 });
const gatewayBudget = budget({ maxReads: 9, maxWrites: 1, maxCommittedRecords: 5, maxEmittedEvents: 12, maxStreamPartitionsTouched: 3 });
const receiptExportBudget = budget({ maxReads: 6, maxWrites: 1, maxCommittedRecords: 1, maxEmittedEvents: 3, maxStreamPartitionsTouched: 3 });
const reconciliationBudget = budget({ maxReads: 7, maxWrites: 1, maxCommittedRecords: 3, maxEmittedEvents: 9, maxStreamPartitionsTouched: 3 });
const recoveryStatusBudget = budget({ maxReads: 5, maxWrites: 1, maxCommittedRecords: 2, maxEmittedEvents: 3, maxStreamPartitionsTouched: 3 });
