  ...
  it("assembles supplied redacted projections and local posture without creating authority", async () => {
    ...
    expect(output).toMatchObject({
      ...
      result: {
        ...
        readbackStages: {
          generatedExecutionRefs: ["graph_demo", "node_demo"],
          contractRef: "contract_demo",
          policyDecisionRef: "policy_demo",
          greenlightRef: "greenlight_demo",
          gatewayCheckRef: "gate_demo",
          credentialResolutionEvidenceRefs: ["credential_resolution_evidence:cre_demo"],
          signerInvocationEvidenceRefs: ["credential:x402-payment-signature:signer-demo"],
          downstreamEvidenceRefs: ["evidence:x402-payment-response:demo"],
          replayRefusalRefs: [],
          refusalRefs: [],
          isolationRefs: ["isolation_state:iso_demo"],
          proofGapRefs: ["proof_gap_demo"],
        },
        localReadiness: {
        ...
        reasonCodeRunbook: [
          ...
          {
            reasonCode: "idempotency_terminal_unknown_recovery_required",
            nextMechanism: "read_evidence",
          },
          {
            reasonCode: "x402_paid_fetch_client_not_blocked",
            nextMechanism: "stop",
          },
        ],
        rawMaterialOmitted: [
...
function supportBundleInput() {
  return {
    ...
    agentTransactionEnvelope: agentTransactionEnvelope(),
...
function contractView() {
  return {
    ...
    generatedExecutionGraphRef: "graph_demo",
    generatedExecutionNodeRef: "node_demo",
    redactionProfileRef: "contract-view:v0.2-redacted",
    omittedFields: ["parameters", "secretRefs", "contractSignature"],
  };
}

function agentTransactionEnvelope() {
  return {
    actionContractRef: "contract_demo",
    contractDigest: digestA,
    policyDecisionRef: "policy_demo",
    ...
    nonSecretParamsSummary: { method: "GET" },
    clearingEvidenceRefs: {},
    surfaceOperationRef: "surface-op-demo",
    surfaceOperationReconciliationRef: "recon_demo",
    surfaceOperationEvidenceLabels: [
      "local_gateway_check",
    ...
    surfaceOperationEvidenceRefs: [
      "evidence:x402-official-payment-signature:signer-demo",
      "credential:x402-payment-signature:signer-demo",
      "evidence:x402-payment-response:demo",
    ],
    gatewayCredentialEvidenceRefs: ["credential:x402-payment-signature:signer-demo"],
    delegatedAuthorityEvidenceRefs: [],
    credentialResolutionEvidenceRefs: ["credential_resolution_evidence:cre_demo"],
    signerInvocationEvidenceRefs: ["credential:x402-payment-signature:signer-demo"],
    downstreamEvidenceRefs: ["evidence:x402-payment-response:demo"],
    authMdEvidenceRefs: {
      discoveryRefs: [],
      authorizationServerRefs: [],
      identityAssertionRefs: [],
      registrationRefs: [],
      claimRefs: [],
      revocationRefs: [],
      credentialCustodyRefs: [],
      credentialResolutionRefs: [],
      protectedApiCallRefs: [],
      downstreamEvidenceRefs: [],
    },
    authMdEvidenceLabels: [],
    providerRequestRef: "provider-request:demo",
    providerOperationRef: "provider-operation:demo",
    downstreamRetryability: "non_retryable",
    reconciliationFinalityStatus: "final",
    gatewayAdmissionStatus: "admitted",
    greenlightConsumptionStatus: "consumed",
    downstreamOutcomeStatus: "unknown",
    proofGapRefs: ["proof_gap_demo"],
    proofGapReasonCodes: ["downstream_status_unknown"],
    refusalRefs: [],
    refusalReasonCodes: [],
    idempotencyLedgerRef: "ledger_demo",
    idempotencyLedgerState: "terminal_unknown",
    idempotencyRecoveryDisposition: "terminal_unknown_requires_recovery",
    idempotencyReasonCodes: ["idempotency_terminal_unknown_recovery_required"],
    recoveryRefs: [],
    isolationRefs: ["isolation_state:iso_demo"],
    authorityCertificateRefs: [],
    evidenceRefs: [
      "credential_resolution_evidence:cre_demo",
      "credential:x402-payment-signature:signer-demo",
      "evidence:x402-payment-response:demo",
    ],
    streamOffsets: [],
