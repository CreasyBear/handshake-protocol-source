...
} from "../src/protocol/object-registry";
import { ProtocolObjectTypeSchema, type ProtocolObjectType, type ProtocolRecord } from "../src/protocol/schemas";
...
const rawReadPostures = new Set<ProtocolObjectRawReadPosture>([
  "control_plane_read",
  "audit_read",
  "internal_only",
]);
